        ...
        if (xaxtime gt 0) then begin
          case n_if_time of  ; non-time ordinate
            3: $ ; change smoothing for quarterly, one week
              spawn,"perl find_moving_avg.perl env_dat.in 6.048e5 4 env_dat.out"
            4: $ ; change smoothing for weekly
              spawn,"perl find_moving_avg.perl env_dat.in 8.64e4 4 env_dat.out -nodrop"
            else: $ ; smooth 1 month
              spawn,"perl find_moving_avg.perl env_dat.in 2.6e6 4 env_dat.out"
          endcase ; case xax of
        endif else begin ; if (xaxtime gt 0) then begin
          case xax of  ; non-time ordinate
            'pt_suncent_ang': $
              spawn,"perl find_moving_avg.perl env_dat.in 10 4 env_dat.out"
            'tephin': $
              spawn,"perl find_moving_avg.perl env_dat.in 5 4 env_dat.out"
            'sc_altitude': $
              spawn,"perl find_moving_avg.perl env_dat.in 5000 4 env_dat.out"
            else: begin
              fma_range=(xmax-xmin)/10
              command="perl find_moving_avg.perl env_dat.in "+$
